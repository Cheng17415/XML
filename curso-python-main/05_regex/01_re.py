...
text = "Todo el mundo dice que la IA nos va a quitar el trabajo. Pero solo hace falta IA ver cómo la puede cagar con las Regex para ir con cuidado"
pattern = "IA"
...
found = re.findall("python",text,re.IGNORECASE)
if found: print(found)
### Reemplazar el texto
