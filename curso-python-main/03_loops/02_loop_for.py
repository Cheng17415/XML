...
print("\nEjercicio 2:")
suma = [num for num in [10, 20, 30, 40, 50]]
...
print("\nEjercicio 4:")
palabras = ["casa", "arbol", "sol", "elefante", "luna"]
lista_5 = [palabra for palabra in palabras if len(palabra) > 5]
print(lista_5)
...
print("\nEjercicio 5:")
palabras = ["casa", "arbol", "sol", "elefante", "luna", "coche"]
let = input("Introduzca un caracter ")
num = 0
for palabra in palabras:
  if let.lower == palabra[0].lower:
    num +=1
print (num)